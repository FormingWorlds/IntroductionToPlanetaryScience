...
\begin{tabular}{@{}lccc@{}}
\toprule
Isotope & Half-life (Gyr) & Heat production (W\,kg$^{-1}$ of isotope) & BSE concentration \\
\midrule
...
Numerator first:
\[
  \alpha\,\rho\,g\,\Delta T = 2 \times 10^{-5} \times 4000 \times 10 \times 2500 = 2000\ \mathrm{kg\,m^{-2}\,s^{-2}},
  \qquad
...
rising steeply with mantle temperature. The balance of the two drives $\dd T/\dd t$.
...
With $H = 0$,
\[
  C\,\frac{\dd T}{\dd t} = -\frac{Q_0}{T_0^{4/3}}\,T^{4/3}.
\]
Separate variables:
\[
  T^{-4/3}\,\dd T = -\frac{Q_0}{C\,T_0^{4/3}}\,\dd t
...
Starting from Earth's typical $r_\mathrm{mp} = 10\,\Rearth$, compute the new standoff
distance.
...
\[
  r_\mathrm{mp}' = 10\,\Rearth \times 10^{-1/6} = \frac{10}{1.4678}\,\Rearth = 6.813\,\Rearth \approx 6.8\,\Rearth.
\]
\answer{$r_\mathrm{mp} \propto (B_0^2/\rho_\mathrm{sw} v_\mathrm{sw}^2)^{1/6}$; a tenfold density surge compresses Earth's magnetopause from $10$ to $\approx 6.8\,\Rearth$. The sixth root is why the magnetosphere is so stable against solar-wind buffeting.}
\end{solution}
