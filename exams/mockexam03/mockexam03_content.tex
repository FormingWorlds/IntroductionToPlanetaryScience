...
Because Titan's weak gravity gives a lapse rate of only about $1.3\ \mathrm{K\,km^{-1}}$, a factor-of-ten change in $P_{\mathrm{sat}}$ spans about $15$ km of altitude, and methane clouds can form over a wide range of altitudes rather than at one sharp cloud base as for water on Earth.
\answer{$P_{\mathrm{sat}} = 17.1\ \mathrm{kPa}$ against a partial pressure of $7.5\ \mathrm{kPa}$: relative humidity $\approx 44\%$. Titan's lakes evaporate into undersaturated air, and its small lapse rate spreads methane clouds over a broad altitude range.}
\end{solution}
...
Cooling the whole planet by $\Delta T$ releases the heat $E = M c\, \Delta T$, with specific heat capacity $c = 1200\ \mathrm{J\,kg^{-1}\,K^{-1}}$, and shrinks the radius by
\[
  \Delta R = \frac{\alpha_V}{3}\, R\, \Delta T, \qquad \alpha_V = 3 \times 10^{-5}\ \mathrm{K^{-1}}.
\]

\parti \pts{4} Compute Mercury's mass from its radius and mean density, and show that cooling the whole planet by $\Delta T = 200\ \mathrm{K}$ releases $7.925 \times 10^{28}\ \mathrm{J}$.
...
The released heat:
\[
  E = M c\, \Delta T = 3.302 \times 10^{23} \times 1200 \times 200 = 7.925 \times 10^{28}\ \mathrm{J}.
\]
\answer{$M = 3.302 \times 10^{23}\ \mathrm{kg}$ and $E = 7.925 \times 10^{28}\ \mathrm{J}$.}
\end{solution}

\parti \pts{3} Assume this heat left the planet at a constant rate over $4.5\ \mathrm{Gyr}$.
Compute the mean surface heat flow in $\mathrm{mW\,m^{-2}}$ and compare it with the Earth's present mean surface heat flow of $90\ \mathrm{mW\,m^{-2}}$.

\begin{solution}
Over $4.5\ \mathrm{Gyr} = 4.5 \times 10^{9} \times 3.156 \times 10^{7} = 1.4202 \times 10^{17}\ \mathrm{s}$:
\[
  P = \frac{7.925 \times 10^{28}}{1.4202 \times 10^{17}} = 5.580 \times 10^{11}\ \mathrm{W}.
\]
Spread over the surface $4\pi R^2 = 7.4815 \times 10^{13}\ \mathrm{m^2}$:
\[
  q = \frac{5.580 \times 10^{11}}{7.4815 \times 10^{13}} = 7.458 \times 10^{-3}\ \mathrm{W\,m^{-2}} \approx 7.5\ \mathrm{mW\,m^{-2}},
\]
about $12$ times below the Earth's $90\ \mathrm{mW\,m^{-2}}$.
...
\answer{$q \approx 7.5\ \mathrm{mW\,m^{-2}}$, far below Earth's $90\ \mathrm{mW\,m^{-2}}$: small planets cool fast and finish their geological activity early.}
\end{solution}
