...
\begin{solution}
\[
  d = 2.46 \times 5.8232 \times 10^{7} \times \left( \frac{687.1}{900} \right)^{1/3}
    = 2.46 \times 5.8232 \times 10^{7} \times 0.9140
    = 1.309 \times 10^{8}\ \mathrm{m} = 130\,900\ \mathrm{km},
\]
...
\answer{$d \approx 131\,000\ \mathrm{km} \approx 2.2\, R_{\mathrm{Saturn}}$: rings inside, moons outside. Tides prevent accretion inside the limit.}
\end{solution}
...
\begin{solution}
The solar flux at Saturn is $S = S_\oplus/a^2 = 1361/9.58^2 = 14.83\ \mathrm{W\,m^{-2}}$.
