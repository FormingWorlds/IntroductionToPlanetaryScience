...
NASA's InSight seismometer also constrained the Mars upper-mantle structure to a depth of $\sim$800 km, identifying a low-velocity zone consistent with a thick thermal lithosphere of $\sim$400–600 km {cite:p}`Khan2021`. Combining this with the seismic core radius {cite:p}`Stahler2021` constrains the Mars mantle to be relatively thin compared to Earth's, with mineral-physics inversions placing an upper-mantle phase transition at $\sim$1000–1100 km depth.
