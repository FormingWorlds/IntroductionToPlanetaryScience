...
The fourth lever is *the stellar evolution history*. The pre-main-sequence high-luminosity phase is decisive for M-dwarf planets, whose habitable zone passes through the runaway boundary during the first few hundred Myr ({ref}`lecture13`; {cite:t}`LugerBarnes2015`). For G dwarfs the effect is smaller but still relevant: the faint young Sun of 4 Gyr ago needed a stronger greenhouse to keep Earth from freezing, and the Sun's slow brightening sets the long-term drift of the inner HZ edge.
