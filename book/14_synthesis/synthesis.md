...
{numref}`fig:board-sketch-l14` shows the setup: the star of luminosity $L_\star$, the planet at distance $d$, and the habitable-zone strip between $d_{\mathrm{in}}$ and $d_{\mathrm{out}}$ that the derivation locates.

<!-- Generated by scripts/figures/board_sketches/render_board_sketches.py -->
```{figure} figures/board_sketch_l14.avif
:name: fig:board-sketch-l14
:width: 45%
:align: center
