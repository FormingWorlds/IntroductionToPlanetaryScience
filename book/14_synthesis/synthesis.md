...
The earliest direct evidence of life on Earth dates to about 3.5 Ga (microbial mat structures in Australia and South Africa). Possible isotopic and morphological biosignatures have been claimed in rocks dating back to $\sim 3.8$ Ga (the Isua banded-iron-formation light-carbon isotopic signatures and the minimum-age cross-cutting zircon constraints in the Nuvvuagittuq Supracrustal Belt) and even, controversially, to $\sim 4.3$ Ga (the $^{146}\mathrm{Sm}$-$^{142}\mathrm{Nd}$ date on the underlying Nuvvuagittuq metabasaltic unit) {cite:p}`Mojzsis1996,Dodd2017`. If those earliest claims hold up, life may have arisen within a few hundred Myr of the cooling of the Earth's surface, which would place a striking upper limit on the timescale required for biology to start.
