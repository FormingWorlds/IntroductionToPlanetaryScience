...
1. **Thermal convection:** The core is hotter than the overlying mantle, so heat flows outward across the core-mantle boundary, at a rate set by how efficiently mantle convection removes it. This cools the top of the outer core: the cooled fluid becomes denser than the fluid beneath it and sinks, while hot fluid rises from depth. Thermal convection operates only if the extracted heat flow exceeds the heat that conduction along the core adiabat can carry on its own.
...
Earth's inner core is widely thought to have nucleated sometime in the past $\sim 1$ Gyr. Two independent approaches converge on very different ages. A thermal-evolution argument, pinned to the high thermal conductivity of iron inferred from first-principles calculations {cite:p}`Labrosse2015`, yields an inner-core age of only $\sim 0.5$–$1$ Gyr. Older thermal-evolution estimates based on lower assumed conductivities favoured ages of $\sim 2$–$3$ Gyr, now largely disfavoured. Paleomagnetic records of the strength of Earth's dipole field show a pulse of intensified field $\sim 0.5$–$1.0$ Gyr ago that has been interpreted as the initiation of compositional convection from a nucleating inner core {cite:p}`Nimmo2015`. Together these lines of evidence place inner-core nucleation near the boundary between the Proterozoic and Phanerozoic eons, about 540 million years ago (0.54 Ga); the Phanerozoic is the most recent eon of the geologic timescale, beginning where abundant animal fossils first appear in the rock record. This timing carries important implications for Earth's long-term thermal history: before inner-core nucleation the geodynamo was purely thermally driven, and the apparent survival of the field for $\sim 3$ billion years in that regime requires higher core heat flows than the present-day compositional-convection regime demands.
