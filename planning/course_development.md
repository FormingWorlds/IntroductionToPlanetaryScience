...
- Checks: the figure script writes the book AVIF and copies it to the L10 deck; `scripts/figures/check_figure_collisions.py` passes for the figure. Every statement attributed to Kite and Conway (2024) is checked against the full text of the Perspective (Nature Geoscience 17, 10, 2024).
