...
- **A3 `fig:goldblatt-runaway`** — Goldblatt et al. 2013 (Nature Geoscience 6, 661). No action: existing AVIF (1297×992) already has all four panels (a–d) and matches the caption precisely. Closed as no-op.
