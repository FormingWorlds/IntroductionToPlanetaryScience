...
- The surrounding text states the 225 K ceiling with its cause (open CO$_2$ spectral windows, weak water-vapour feedback), puts the collision-induced absorption sentence and the H$_2$ sources before the figure, keeps the impact-only proposal as one sentence with the duration and number constraints of Kite and Conway (2024), and gives the closing timescale paragraph two sources: the Kite (2019) abstract for the durations (longest single river-forming period more than $10^2$ to $10^3$ yr, more than $10^5$ wet years in total, at least 2 river-forming periods) and Kite and Conway (2024) for the count of about 7 major transitions with volcanism and obliquity as candidate drivers.
...
- Checks: the figure script writes the book AVIF and copies it to the L10 deck; `scripts/figures/check_figure_collisions.py` passes for the figure. The full text of Kite and Conway (2024) was not available, so the text quotes only what its abstract and press summary state.

The picture follows the Kite (2019) and Kite and Conway (2024) reviews: a cold baseline with repeated warm excursions is the working hypothesis, not a consensus, and the caption and the slide say so.
