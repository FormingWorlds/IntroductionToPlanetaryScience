...
- **Length budget (2026-09-10):** deck 49 frames (from 85; 46 after the cut, then figures added to concept frames), notes about 7900 words (from 11549), board sheet 5 live steps; the closing item is the frontier missions of the 2030s on one hero frame; Worksheet 7 drops its direct-imaging and Drake problem and three parts (4 problems, 13 parts).
