...
\begin{frame}{What Worksheet 7 trains}
  \small
  Four problems, all built on Lectures 13--14. The physics you need, per problem:
  \begin{enumerate}
...
\begin{frame}{Scale heights and transmission spectra}
  ...
  \begin{columns}[T]
    ...
    \begin{itemize}
      ...
      \item For comparison, a rocky $\mathrm{CO_2}$ planet has $H$ of a few km, so a signal $\sim 100$ times smaller.
    \end{itemize}
