...
\begin{frame}{Scale heights and transmission spectra}
  ...
  \begin{columns}[T]
    ...
    \[
      \boxed{H = \frac{k_\mathrm{B} T}{\mu\,u\,g}} \qquad \frac{\Delta\delta}{\delta} \approx \frac{2 n_H H}{R_p}
    \]
    \begin{itemize}
...
\begin{frame}{Equilibrium temperature and the habitable zone}
  ...
  \begin{columns}[T]
    ...
    \[
      \boxed{T_\mathrm{eq} = \left[\frac{L_\star(1-A_\mathrm{B})}{16\pi\sigma\epsilon d^2}\right]^{1/4}} \quad d = \sqrt{\frac{L_\star/L_\odot}{S_\mathrm{eff}}}\ \mathrm{AU}
    \]
    \begin{itemize}
