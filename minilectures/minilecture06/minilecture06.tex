...
\begin{frame}{What Worksheet 6 trains}
  Four problems, all built on Lectures 11--12. The physics you need, per problem:
  \vskip4pt\relax
  \begin{enumerate}
    ...
    \item \textbf{Radioactive dating}: the decay law, short-lived $^{26}$Al heating, the long-lived U-Pb clock.
...
\begin{frame}{The Roche limit and Saturn's rings}
  ...
  \begin{columns}[T]
    ...
    \begin{block}{Rings inside, moonlets survive}
      Ice is disrupted out to the fluid limit, so it stays as rings; a denser rocky body survives much closer in. Pan and Daphnis, porous moonlets near $400$ kg m$^{-3}$, orbit between the rigid and fluid limits for their own density, held by gravity plus finite strength.
    \end{block}
  \end{columns}
