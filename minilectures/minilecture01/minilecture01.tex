...
\begin{frame}{What Worksheet 1 trains}
  ...
  \begin{enumerate}
    ...
    \item \textbf{Planetesimals to planets}: gravitational focusing and the growth regimes.
  \end{enumerate}
  \vskip6pt\relax
...
\begin{frame}{Weighing by orbits: Kepler's third law}
  \begin{columns}[T]
    ...
    \begin{itemize}
      ...
      \item Works for \emph{any} central body: here, the Sun from Jupiter's orbit.
    \end{itemize}
...
% ── Problem 5 concepts ──────────────────────────────────────
\begin{frame}{Planetesimals to planets}
  \begin{columns}[T]
    \column{0.52\textwidth}
    ...
    \column{0.44\textwidth}
    \begin{block}{How big is the boost?}
      \begin{itemize}\setlength\itemsep{1pt}
        \item Cold swarm ($v_\infty = 10$ m/s): a 500 km body focuses $\sim$4000-fold.
        \item Hot swarm ($v_\infty = 500$ m/s): the boost collapses to a factor of a few.
      \end{itemize}
    \end{block}
  \end{columns}
  \vskip0pt\relax
