...
H_T = kB * 94 / (27.4 * m_u * 1.35)
chk("P1a H_Titan (km)", H_T / 1e3, 21.13, 1e-3)
chk("P1a H_Titan numerator", kB * 94, 1.2981e-21)
chk("P1a H_Titan denominator", 27.4 * m_u * 1.35, 6.1440e-26)
# printed-chain: the division of the two PRINTED 5-sf values
chk("P1a H_Titan printed-chain (m)", 1.2981e-21 / 6.1440e-26, 21128, 5e-5)
# ── Problem 3(b), 3(c): saturation-curve slopes and cloud-base thickness ─────
chk("P3b CH4 Psat ratio 94/90 K", math.exp(980 * (1/90 - 1/94)), 1.6, 2e-2)
chk("P3c CH4 slope at 90 K (1/K)", 980 / 90**2, 0.121, 2e-3)
chk("P3c H2SO4 slope at 350 K (1/K)", 6400 / 350**2, 0.052, 6e-3)
chk("P3c decade span Titan (K)", math.log(10) / 0.121, 19, 2e-2)
chk("P3c decade span Venus (K)", math.log(10) / 0.052, 44, 1e-2)
chk("P3c Venus lapse rate (K/km)", 8.87 / 900 * 1e3, 9.9, 5e-3)
