...
def make_plot() -> plt.Figure:
    ...
    box(ax, 0.4, 4.3, 11.2, 1.7, "#e8e2d4", "#6b5e4a", "Crust",
        "continental crust enriched in incompatible elements (U, Th, K) by partial melting and crustal extraction;\noceanic crust: basalt returned to the mantle by subduction")
    box(ax, 0.4, 0.4, 5.4, 3.2, "#e8f1fa", "#1f6db8", "Depleted MORB mantle (DMM)",
        "source of mid-ocean ridge basalts;\ndepleted in incompatible elements over Gyr")
    box(ax, 6.2, 0.4, 5.4, 3.2, "#fdebd0", "#c46b1a", "Enriched mantle",
        "deep reservoirs sampled by plumes (ocean island\nbasalts, e.g. Hawaii, Iceland); less-processed\nprimordial material or recycled oceanic crust")
