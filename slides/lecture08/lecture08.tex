...
% ── Seismic waves ────────────────────────────────────────────
\begin{frame}
  \ipsherokey[0.67]{seismic_waves}{P- and S-wave paths through Earth's interior. Credit: Wikimedia Commons, public domain.}{P-waves ($v_P = \sqrt{(K + \tfrac{4}{3}\mu)/\rho}$) travel through solids and liquids; S-waves ($v_S = \sqrt{\mu/\rho}$) need $\mu > 0$, so they \textbf{cannot propagate} through a liquid.}
\end{frame}

% ── Shadow zones hero ────────────────────────────────────────
\begin{frame}
  \ipsherokey[0.66]{prem_shadow_zones}{Rays traced through PREM, the standard seismological model of Earth's interior. Course original, from the PREM tabulation of Dziewonski \& Anderson (1981).}{No S-waves beyond 103\textdegree{} proves the outer core is liquid; P-wave refraction creates a shadow zone from 103\textdegree{} to 143\textdegree{}.}
\end{frame}
...
% ── Birch's law ──────────────────────────────────────────────
\begin{frame}
  \ipsherokey[0.61]{birchs_law}{Birch's law: $v_P$ against density for mantle minerals, trend after Birch (1952). Course original.}{$v_P = a(\bar{M}) + b\,\rho$: compressional velocity scales linearly with density at a given mean atomic weight $\bar{M}$, so seismic speeds map to density; iron-rich minerals plot below the trend, and the law breaks down across compositional boundaries and phase transitions.}
\end{frame}
...
% ── PREM ─────────────────────────────────────────────────────
\begin{frame}
  \ipsherokey[0.61]{prem_density}{Density against depth in the \textbf{Preliminary Reference Earth Model} (PREM). Credit: Dziewonski \& Anderson (1981).}{Density rises from $\sim$3300~kg\,m$^{-3}$ in the upper mantle to $\sim$5500 at its base, jumps to 9900--12{,}200 in the outer core and reaches $\sim$13{,}000 in the inner core; the 410 and 660~km steps are phase transitions, the core-mantle boundary is silicate to iron.}
\end{frame}
...
% ── Mars interior hero ───────────────────────────────────────
\begin{frame}
  \ipsherokey[0.61]{mars_interior_insight}{Mars's interior from InSight seismology: a 24--72~km crust, a mantle to $\sim$1560~km, and the core. Credit: NASA/JPL-Caltech (PIA25282).}{The seismic boundary at $R_c \sim 1830$~km was reinterpreted in 2023 as the top of a molten silicate layer above a smaller ($\sim$1650--1675~km) liquid iron core of about 6500~kg\,m$^{-3}$.}
\end{frame}
...
\begin{frame}
  \ipsherokey[0.61]{soderlund2020_planetary_field_morphologies}{Radial magnetic field at the surface of six planets in Mollweide projection. Credit: Soderlund et al.\ (2020), Fig.~1.}{Uranus and Neptune generate multipolar fields tilted by 59\textdegree{} and 47\textdegree{} and offset from the centre, from dynamos in thin outer fluid ice shells; Uranus emits negligible internal heat, Neptune $\sim$2.6$\times$ the solar flux.}
\end{frame}
...
\begin{frame}
  \ipshero{stahler2021_mars_vp_vs}{Mars velocity profiles from InSight: $v_S$ drops to zero at the core boundary, confirming a liquid metallic core. Credit: St\"ahler et al.\ (2021), Fig.~2A.}
\end{frame}
