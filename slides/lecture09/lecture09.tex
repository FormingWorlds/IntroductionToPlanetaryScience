...
\begin{frame}
  \centering
  \makebox[\linewidth][c]{\includegraphics[width=0.95\paperwidth, height=0.72\paperheight, keepaspectratio]{terrestrial_planets}}\\
  {\footnotesize Mercury, Venus, Earth, Mars relative scale. Inner rocky planets sharing similar accretion zones but diverging into radically different surface environments. Credit: NASA/JPL.}
\end{frame}
...
\begin{frame}
  \centering
  \makebox[\linewidth][c]{\includegraphics[width=0.95\paperwidth, height=0.72\paperheight, keepaspectratio]{family_portrait}}\\
  {\footnotesize Voyager 1 Solar System family portrait (1990). Inset frames show the planets detected across the outer and inner Solar System, illustrating planetary divergence from a shared disk. Credit: NASA/JPL-Caltech.}
\end{frame}
...
\begin{frame}
  ...
  {\footnotesize Geologic eons and eras of Earth across 4.54 Gyr of planetary history. The informal Precambrian occupies almost 90\% of the timeline before the Phanerozoic diversification of macroscopic life. Credit: Gradstein et al.\ (2020).}
\end{frame}
...
\begin{frame}
  \centering
  \makebox[\linewidth][c]{\includegraphics[width=0.95\paperwidth, height=0.72\paperheight, keepaspectratio]{catling2020_precambrian_events}}\\
  {\footnotesize Geologic timeline of the Precambrian showing major environmental milestones, from early liquid oceans through the Great Oxidation Event to late Neoproterozoic glaciations and ozone layer formation. Credit: Catling \& Zahnle (2020).}
\end{frame}

\begin{frame}
  \centering
  \makebox[\linewidth][c]{\includegraphics[width=0.95\paperwidth, height=0.62\paperheight, keepaspectratio]{lyons2014_oxygen_history}}\\
  {\footnotesize Atmospheric oxygen through Earth history on a logarithmic scale relative to the present level: essentially anoxic (below $10^{-5}$ of present) for the first about 2 Gyr, an abrupt rise at the Great Oxidation Event near 2.4 Ga, a plateau at intermediate values through the mid-Proterozoic, and a second rise to near-modern levels in the Neoproterozoic and Phanerozoic, tracking the growth of the photosynthetic biosphere and the redox balance with the deep ocean and crust. Reproduced from Lyons et al.\ (2014).}
\end{frame}
...
\begin{frame}
  \centering
  \makebox[\linewidth][c]{\includegraphics[width=0.95\paperwidth, height=0.72\paperheight, keepaspectratio]{snowball_earth}}\\
  {\footnotesize Global glaciation during Cryogenian Snowball Earth episodes. High ice albedo maintained freezing conditions until volcanic outgassing and carbonate-silicate feedbacks forced deglaciation. Credit: Oleg Kuznetsov, Wikimedia Commons, CC BY-SA 4.0.}
\end{frame}
...
\begin{frame}{Hydrosphere and Cryosphere}
  \begin{columns}[c]
    \column{\recapfigcol}
    \ipsrecapfig{blue_marble_apollo17}
...
\begin{frame}
  \centering
  \makebox[\linewidth][c]{\includegraphics[width=0.95\paperwidth, height=0.60\paperheight, keepaspectratio]{charnay2013_archean_temperature}}\\
  {\footnotesize Global mean surface temperature of the Archean Earth from 3.8 to 2.5 Ga in a 3D general-circulation model for three compositions: 0.9 mbar CO$_2$ with 0.9 mbar CH$_4$ (blue), 10 mbar CO$_2$ with 2 mbar CH$_4$ (orange), 0.1 bar CO$_2$ with 2 mbar CH$_4$ (red); solid with methane, dashed without; the dotted green line is the freezing point. A few mbar of CO$_2$ is marginal at 3.8 Ga; about 0.1 bar resolves the faint-young-Sun problem at all three epochs. Reproduced from Charnay et al.\ (2013).}
\end{frame}
...
\begin{frame}
  \centering
  \makebox[\linewidth][c]{\includegraphics[width=0.95\paperwidth, height=0.72\paperheight, keepaspectratio]{venus_earth_mars_atmospheres}}\\
  {\footnotesize Surface temperature and surface pressure comparison for Venus, Earth, and Mars. Near-twins in bulk size and density, Venus and Earth differ by a factor of 92 in pressure and 450 K at the surface. Credit: Course-original figure; data from NASA Fact Sheet.}
\end{frame}
...
\begin{frame}{Venus: A Long Mission History}
  \begin{columns}[c]
    \column{\recapfigcol}
    \ipsrecapfig[0.55\textheight]{venera13_venus_surface}
...
\begin{frame}
  \centering
  \makebox[\linewidth][c]{\includegraphics[width=0.95\paperwidth, height=0.72\paperheight, keepaspectratio]{honing2021_reference_evolution}}\\
  {\footnotesize Coupled interior-atmosphere evolution of a stagnant-lid Venus. Surface weathering sustains temperate conditions for 0.9 Gyr until water loss triggers runaway crustal decarbonation to a 92-bar end state. Credit: Honing et al.\ (2021).}
\end{frame}
...
\begin{frame}
  \centering
  \makebox[\linewidth][c]{\includegraphics[width=0.95\paperwidth, height=0.72\paperheight, keepaspectratio]{venus_activity_evidence}}\\
  {\footnotesize Three lines of evidence for present-day volcanism on Venus on one timeline: cloud-top SO$_2$ swings, Venus Express thermal anomalies at Idunn Mons, and the Maat Mons vent change in Magellan radar (Herrick and Hensley 2023). Course figure.}
\end{frame}
...
\begin{frame}
  ...
  {\footnotesize Venus atmospheric temperature profile from the 737 K, 92 bar surface through the cloud deck (48--70 km) to 100 km, showing a monotonic dry adiabatic lapse rate. Credit: Pioneer Venus / VIRA and Venus Express; course-original figure.}
\end{frame}
...
\begin{frame}
  \centering
  \makebox[\linewidth][c]{\includegraphics[width=0.95\paperwidth, height=0.72\paperheight, keepaspectratio]{kopparapu2013_runaway_panels}}\\
  {\footnotesize Climate-model calculation of the runaway greenhouse threshold. Outgoing longwave radiation asymptotes to 282--291 W/m$^2$ as water vapour closes infrared spectral windows at high surface temperature. Credit: Kopparapu et al.\ (2013).}
\end{frame}
...
\begin{frame}
  \centering
  \makebox[\linewidth][c]{\includegraphics[width=0.95\paperwidth, height=0.72\paperheight, keepaspectratio]{wordsworth2013_OLR_ASR_equilibria}}\\
  {\footnotesize Outgoing longwave radiation and absorbed shortwave radiation equilibria as a function of surface temperature, showing multiple thermal equilibria in saturated greenhouse atmospheres. Credit: Wordsworth et al.\ (2013).}
\end{frame}
...
\begin{frame}
  \centering
  \makebox[\linewidth][c]{\includegraphics[width=0.95\paperwidth, height=0.72\paperheight, keepaspectratio]{goldblatt2013_olr_spectrum}}\\
  {\footnotesize Thermal-radiance spectra of a water-rich atmosphere for surface temperatures from 280 to 400 K, showing flux saturation at the runaway-greenhouse asymptote of 282 W/m$^2$ as the 8--14 $\mu$m window closes. Credit: Goldblatt et al.\ (2013).}
\end{frame}
...
\begin{frame}
  \centering
  \makebox[\linewidth][c]{\includegraphics[width=0.95\paperwidth, height=0.72\paperheight, keepaspectratio]{hamano2013_two_types}}\\
  {\footnotesize Solidification timescale and final retained water for Type I and Type II terrestrial planets. Beyond the critical runaway distance (0.77 AU), magma oceans solidify rapidly and retain surface oceans. Credit: Hamano et al.\ (2013).}
\end{frame}
...
\begin{frame}
  \centering
  \makebox[\linewidth][c]{\includegraphics[width=0.95\paperwidth, height=0.72\paperheight, keepaspectratio]{gillmann2022_dry_wet_venus_scenarios}}\\
  {\footnotesize Two end-member evolutionary branches for Venus water history. Early hydrodynamic loss during a magma ocean phase (top branch) contrasts with late desiccation following an extended habitable period (bottom branch). Credit: Gillmann et al.\ (2022).}
\end{frame}

\begin{frame}
  \centering
  \makebox[\linewidth][c]{\includegraphics[width=0.95\paperwidth, height=0.55\paperheight, keepaspectratio]{lebrun2013_magma_ocean_evolution}}\\
  {\footnotesize Potential temperature (black) and surface temperature (grey) of a crystallising magma ocean coupled to its steam atmosphere on a Venus-mass planet at Venus's orbit; the three regions track the mantle from totally molten to mush, water vapour condenses at the partially-molten to mush boundary, and the dashed line marks 98\% solidification at about 10 Myr (1.5 Myr at Earth's orbit, 0.1 Myr at Mars's). The long-lived steam atmosphere has time to photolyse and lose hydrogen: the basis of the early-loss scenario. Below about 0.66 AU the magma ocean never freezes; Venus at 0.72 AU sits just outside that limit.}
\end{frame}
...
\begin{frame}{The Loss Mechanism: Photolysis + Escape}
  \begin{columns}[c]
    \column{\recapfigcol}
    \ipsrecapfig[0.55\textheight]{wordsworth2014_abiotic_o2_schematic}
...
\begin{frame}
  \centering
  \makebox[\linewidth][c]{\includegraphics[width=0.95\paperwidth, height=0.72\paperheight, keepaspectratio]{wordsworth2016_n2_redox_pump}}\\
  {\footnotesize The water-loss redox pump linking atmospheric nitrogen to early water loss. Hydrogen escape drives mantle oxidation and leaves a 92-bar $\mathrm{CO_2}$ atmosphere, contrasting with Earth's 1-bar $\mathrm{N_2}$ state. Credit: Wordsworth (2016).}
\end{frame}
...
\begin{frame}{Carbonate-Silicate Cycle: Failure Mode}
  \begin{columns}[c]
    \column{\recapfigcol}
    \ipsrecapfig[0.55\textheight]{honing2021_carbon_cycle_diagram}
    \source{Honing et al.\ (2021)}
...
\begin{frame}
  \centering
  \makebox[\linewidth][c]{\includegraphics[width=0.95\paperwidth, height=0.55\paperheight, keepaspectratio]{dauphas2017_earth_accreting_material}}\\
  {\footnotesize Probability density for the chromium-bearing fraction of Earth's accreting mass against the cumulative accreted mass fraction: 95\% of the mantle's Cr arrived during the final 85\% of accretion, close to mass-proportional delivery, unlike Mo and Ru, which are back-loaded to the final stages. With the O, Ti, Ni, Mo and Ru tracers this reconstructs three accretion stages: the first 60\% of Earth's mass about 51\% enstatite-like, 40\% ordinary-chondrite and 9\% carbonaceous material, the rest essentially enstatite-like. The carbonaceous component, and with it most of Earth's water, came early rather than in the late veneer.}
\end{frame}

\begin{frame}
  \centering
  \makebox[\linewidth][c]{\includegraphics[width=0.95\paperwidth, height=0.72\paperheight, keepaspectratio]{earth_life_timeline}}\\
  {\footnotesize Major milestones in the history of life on Earth across 4.54 Gyr. Continuous habitability supported the transition from early microbial life to complex organisms, an evolutionary path denied to Venus. Credit: Course-original figure.}
\end{frame}

\begin{frame}
  \centering
  \makebox[\linewidth][c]{\includegraphics[width=0.95\paperwidth, height=0.66\paperheight, keepaspectratio]{stromatolites_shark_bay}}\\
  {\footnotesize Modern stromatolites in the hypersaline water of Shark Bay, Western Australia: microbial mats trap and bind sediment into layered mounds. Fossil stromatolites of the same construction in the nearby Pilbara, dated to 3.48 Ga, are the oldest widely accepted evidence for life on Earth. Photo by Paul Harrison (Wikimedia Commons), [CC BY-SA 3.}
\end{frame}
