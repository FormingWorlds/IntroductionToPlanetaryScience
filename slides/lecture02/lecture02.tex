...
\begin{frame}{PDS 70: Planets Caught in the Act}
  In 2018--2019, VLT/SPHERE and ALMA directly imaged \textbf{two protoplanets} inside the disk gap of PDS 70:
  \vskip6pt
  \begin{itemize}
    \item \textbf{PDS 70 b}: $\sim$6~$M_\mathrm{Jup}$, $\sim$20~AU, $T \approx 1200$~K
    \item \textbf{PDS 70 c}: similar mass, at $\sim$35~AU
    \item H$\alpha$ emission indicates active accretion onto both planets
    \item A circumplanetary disk detected around PDS 70 c (Benisty et al.\ 2021)
    \item First direct evidence of giant planets forming inside a disk gap
    \item Supports the interpretation that gaps in DSHARP disks are sculpted by embedded protoplanets
  \end{itemize}
  \vskip4pt
  {\tiny\color{ipsText!60} Source: Keppler et al.\ (2018); Haffert et al.\ (2019)}
\end{frame}
