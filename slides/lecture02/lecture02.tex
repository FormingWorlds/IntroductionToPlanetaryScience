...
\begin{frame}{Visualising Kepler's Laws}
  \centering
  \includegraphics[height=0.70\textheight]{kepler_laws}
...
\begin{frame}{Six Orbital Elements}
  \begin{columns}[c]
    ...
    \centering
    \includegraphics[height=0.65\textheight]{orbital_elements}
...
\begin{frame}{The Roche Limit}
  \begin{columns}[c]
    ...
    \vskip4pt
    Saturn's rings extend from 67,000 to 137,000~km --- \textbf{within the Roche limit}.
  \end{columns}
\end{frame}
