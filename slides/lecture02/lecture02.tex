...
\begin{frame}{High-Eccentricity Migration}
  ...
  \begin{itemize}
    ...
    \item \textbf{Kozai--Lidov mechanism:} a distant stellar or planetary companion torques a planet into a high-eccentricity, high-inclination orbit
...
\begin{frame}{More Recent Advances}
  \begin{itemize}
    ...
    \vskip4pt
    \item \textbf{Psyche:} NASA mission (launch 2023) to study a metal-rich asteroid, a possible naked core
  \end{itemize}
\end{frame}
