...
\begin{frame}
  \ipsherokey[0.66]{raymond2022_period_radius}{Transiting census with compact multi-planet systems boxed: five uniform ones (middle), three non-uniform ones (bottom). Weiss et al.\ (2023, PPVII).}{Many compact multi-planet systems show striking size uniformity (middle), while others do not (bottom).}
\end{frame}
