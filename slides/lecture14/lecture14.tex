...
\begin{frame}
  \ipsherokey[0.62]{elt_milkyway}{The Milky Way over the ELT site. Credit: C. Letelier/ESO.}{Whether our architecture is rare stays open until PLATO (2027) and Gaia DR4 (late 2026) reach the 1~AU analogues; the 39~m ELT will then image temperate rocky planets around nearby M dwarfs directly.}
\end{frame}
...
\begin{frame}
  \ipsherokey[0.6]{sandberg2018_drake_posterior}{Monte Carlo posterior for the number $N$ of communicating civilisations, sampled over the full published parameter ranges. Sandberg, Drexler \& Ord (2018).}{The distribution is broad and heavy-tailed, with about a third of the probability below $N = 1$ in the Milky Way: the apparent cosmic silence is unsurprising once the priors are honest.}
\end{frame}
