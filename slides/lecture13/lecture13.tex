...
\begin{frame}
  \centering
  \makebox[\linewidth][c]{\includegraphics[width=0.95\paperwidth, height=0.64\paperheight, keepaspectratio]{radial_velocity_signal}}\\
  {\footnotesize (a) The reflex velocity of a Sun with a Jupiter analogue, $K_\star = 12.5$ m\,s$^{-1}$, against the precisions of ELODIE (10 m\,s$^{-1}$), HARPS (1 m\,s$^{-1}$) and ESPRESSO (0.1 m\,s$^{-1}$). (b) The semi-amplitudes of a Jupiter analogue, Saturn at 9.5 AU (2.7 m\,s$^{-1}$) and Earth at 1 AU (0.09 m\,s$^{-1}$): an Earth analogue sits below the instrumental floor and within the stellar noise. Course figure.}
\end{frame}
...
\begin{frame}
  \centering
  \makebox[\linewidth][c]{\includegraphics[width=0.95\paperwidth, height=0.64\paperheight, keepaspectratio]{lichtenberg2025_mass_radius}}\\
  {\footnotesize Mass against radius for small exoplanets with interior models from pure iron to volatile-rich envelopes, sorted by thermal regime: rocky super-Earths follow the silicate-iron curves, sub-Neptunes need substantial volatile envelopes or water-rich layers to explain their larger radii. Reproduced from Lichtenberg et al.\ (2025).}
\end{frame}
...
\begin{frame}
  \centering
  \makebox[\linewidth][c]{\includegraphics[width=0.95\paperwidth, height=0.72\paperheight, keepaspectratio]{betapic_imaging}}\\
  {\footnotesize Direct image of $\beta$ Pictoris b from Lagrange et al.\ (2010), showing orbital motion between 2003 and 2009 that confirms a bound $\sim 9\,\Mjup$ companion at $\sim 9$ AU. Credit: ESO/A.-M.\ Lagrange et al.}
\end{frame}
...
\begin{frame}
  \centering
  \makebox[\linewidth][c]{\includegraphics[width=0.95\paperwidth, height=0.72\paperheight, keepaspectratio]{pds70_disk}}\\
  {\footnotesize Composite scattered-light image of the PDS 70 protoplanetary disk showing the parent circumstellar disk and two embedded protoplanets inside the cleared gap. Credit: Haffert et al.\ (2019).}
\end{frame}
...
\begin{frame}
  \centering
  \makebox[\linewidth][c]{\includegraphics[width=0.95\paperwidth, height=0.64\paperheight, keepaspectratio]{astrometric_signal}}\\
  {\footnotesize Astrometric reflex amplitude $\alpha = (m_p/M_\star)(a_p/d)$ against distance for a Jupiter analogue at 5.2 AU and an Earth analogue at 1 AU: at 10 pc about 500 microarcseconds (half a milliarcsecond) and 0.3 microarcseconds. The dashed line is Gaia's final precision of about 10 microarcseconds for bright stars, the regime in which Jupiter analogues become accessible. Course figure.}
\end{frame}
...
\begin{frame}
  \centering
  \makebox[\linewidth][c]{\includegraphics[width=0.95\paperwidth, height=0.64\paperheight, keepaspectratio]{microlensing_lightcurve}}\\
  {\footnotesize A microlensing event with a planet: the magnification of a background source as the lens star passes in front of it (impact parameter 0.3 Einstein radii, Einstein crossing time 15 days), and the spike of hours to days that a planet around the lens adds; its amplitude and timing give the planet's mass and projected separation in Einstein radii. Course figure.}
\end{frame}

\begin{frame}
  \centering
  \makebox[\linewidth][c]{\includegraphics[width=0.95\paperwidth, height=0.64\paperheight, keepaspectratio]{exoplanet_mass_period}}\\
  {\footnotesize Confirmed exoplanet masses (or minimum masses $m_p \sin i$) against orbital period, coloured by detection technique, with the solar-system planets for comparison: detection biases concentrate discoveries at high mass and short period and leave Earth analogues in a sparsely sampled region. Credit: NASA Exoplanet Archive {cite:p}`NASAExoplanetArchive2026`. Course figure.}
\end{frame}
...
\begin{frame}
  \centering
  \makebox[\linewidth][c]{\includegraphics[width=0.95\paperwidth, height=0.60\paperheight, keepaspectratio]{transit_timing_variations}}\\
  {\footnotesize (a) Transit timing variations: the observed minus calculated transit times of a planet perturbed by a companion oscillate about the constant-period prediction (5 minute amplitude over 12 transits, schematic); amplitude and period encode the companion's mass. (b) The three timing methods: transit timing variations (dynamical masses, TRAPPIST-1), pulsar timing (the first exoplanets, 1992) and eclipse timing in binaries (circumbinary planets, Kepler-16 b in 2011). Course figure.}
\end{frame}
...
\begin{frame}
  \centering
  \makebox[\linewidth][c]{\includegraphics[width=0.95\paperwidth, height=0.72\paperheight, keepaspectratio]{ginzburg_corepowered}}\\
  {\footnotesize Core-powered mass loss model of the radius valley: envelope loss driven by heat from the cooling rocky interior produces a bimodal distribution with a gap at $\sim 1.8\,\Rearth$. Credit: Ginzburg et al.\ (2018).}
\end{frame}
...
\begin{frame}
  \centering
  \makebox[\linewidth][c]{\includegraphics[width=0.95\paperwidth, height=0.72\paperheight, keepaspectratio]{gj1214b_clouds}}\\
  {\footnotesize Featureless transmission spectrum of the warm sub-Neptune GJ 1214 b from HST data: ruling out cloud-free $\mathrm{H_2O}$, $\mathrm{CH_4}$, and $\mathrm{CO_2}$ atmospheres demonstrates high-altitude clouds or hazes. Credit: Kreidberg et al.\ (2014).}
\end{frame}
...
\begin{frame}
  \centering
  \makebox[\linewidth][c]{\includegraphics[width=0.95\paperwidth, height=0.72\paperheight, keepaspectratio]{sing_hotjup_spectra}}\\
  {\footnotesize Transmission spectra of ten hot Jupiters from HST and Spitzer across $0.3$--$5\ \mu\mathrm{m}$, revealing a continuum from clear atmospheres with prominent water absorption to cloudy, aerosol-dominated scattering slopes. Credit: Sing et al.\ (2016).}
\end{frame}
...
\begin{frame}
  \centering
  \makebox[\linewidth][c]{\includegraphics[width=0.95\paperwidth, height=0.72\paperheight, keepaspectratio]{wasp43b_phase_curve}}\\
  {\footnotesize JWST/MIRI spectroscopic phase curve of WASP-43 b across orbital phase, showing thermal emission variation from dayside to nightside and constrained atmospheric heat redistribution. Credit: Bell et al.\ (2024).}
\end{frame}
...
\begin{frame}
  \centering
  \makebox[\linewidth][c]{\includegraphics[width=0.95\paperwidth, height=0.62\paperheight, keepaspectratio]{55cnce_hu_emission}}\\
  {\footnotesize JWST NIRCam and MIRI thermal emission spectrum of 55 Cancri e: the binned data fall below the bare-rock blackbody at most wavelengths and favour atmospheric models with CO and CO$_2$, tentative evidence for a secondary atmosphere outgassed from a molten surface.}
\end{frame}

\begin{frame}
  \centering
  \makebox[\linewidth][c]{\includegraphics[width=0.95\paperwidth, height=0.62\paperheight, keepaspectratio]{lhs475b_spectrum}}\\
  {\footnotesize JWST NIRSpec G395H transmission spectrum of LHS 475 b, an Earth-size M dwarf planet at about 12 pc: flat and featureless. Hydrogen-helium atmospheres are ruled out at high confidence, a pure CH$_4$ atmosphere too, and a Venus-like pure CO$_2$ atmosphere remains marginally consistent.}
\end{frame}
...
\begin{frame}
  \centering
  \makebox[\linewidth][c]{\includegraphics[width=0.95\paperwidth, height=0.62\paperheight, keepaspectratio]{schwieterman2018_biosignature_gases}}\\
  {\footnotesize Absorption cross-sections from 0.4 to 20 $\mu$m for ten candidate biosignature gases (O$_2$, O$_3$, N$_2$O, CH$_4$, CH$_3$Cl, C$_2$H$_6$, NH$_3$, dimethyl sulfide, dimethyl disulfide, CH$_3$SH): oxygen absorbs only in narrow optical bands, the others have their strongest features in the infrared. Reproduced from Schwieterman et al.\ (2018).}
\end{frame}
