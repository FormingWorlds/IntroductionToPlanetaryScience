...
\begin{frame}
  \ipsherokey[0.54]{jupiter_dilute_core_wahl2017}{Density against fractional radius for Jupiter interior models with compact and dilute cores for two equations of state (MH13 solid, REOS3 dashed); metallic hydrogen begins at $\sim 100$~GPa, $r/R_J \approx 0.85$. Wahl et al.\ (2017).}{Juno's gravity harmonics $J_4$ to $J_{10}$ rule out a compact $\sim 10\,\Mearth$ core. Instead $20$--$40\,\Mearth$ of heavy elements spread over the inner $30$--$50\%$ of the radius, mixed during accretion or by a giant impact (Liu et al.\ 2019).}
\end{frame}
...
\begin{frame}
  \ipshero{callisto_cutaway}{Interior structures of the four Galilean moons at comparable scale: only Callisto (right) is partially differentiated, with a mixed rock-ice interior. Credit: NASA/JPL-Caltech.}
\end{frame}
...
% ── Modern Uranus ───────────────────────────────────────────
\begin{frame}
  \ipsherokey[0.66]{uranus_cyclone}{Microwave views of Uranus from the Very Large Array, with the bright north-polar cyclone. Credit: NASA/JPL-Caltech/VLA.}{Since the 2007 equinox, toward northern summer (2030), cloud activity and storms increase. The VLA and JWST confirm a warm north-polar cyclone.}
\end{frame}
