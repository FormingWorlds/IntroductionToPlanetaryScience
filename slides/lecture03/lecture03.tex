...
\begin{frame}{Surface Heat Flow}
  ...
  \begin{tabular}{l c c l}
    ...
    Io     & 2000--3000 & $\sim$130--160 & \textbf{Tidal dissipation} \\
    \bottomrule
  \end{tabular}
  \vskip6pt
  {\tiny\color{ipsText!60} Source: Davies \& Davies (2010); Veeder et al.\ (2012); InSight + gravity/topography estimates}
  \vskip10pt
  Io's heat flux is 20--30$\times$ higher than Earth's per unit area. Total power ($\sim$$1.5\times$ Earth's 47~TW) is smaller than the flux ratio suggests because Io's mass is only $\sim$1\% of Earth's.
\end{frame}
