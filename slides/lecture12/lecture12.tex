...
\begin{frame}
  \ipsherokey[0.65]{small_bodies_overview}{Small bodies visited by spacecraft, to scale with terrestrial landmarks. \mbox{Credit: NASA/JPL-Caltech.}}{Three reservoirs hold them: the main belt ($2.1$--$3.3$~AU, $\sim 4 \times 10^{-4}\,\Mearth$), the Kuiper Belt, and the Oort cloud ($2{,}000$--$50{,}000$~AU, inferred, never directly observed).}
\end{frame}
...
\begin{frame}{Why Meteorites Matter}
  \begin{itemize}\setlength\itemsep{4pt}
    \item \textbf{Laboratory access:} $\sim$70{,}000 catalogued specimens; the primitive ones are older than the oldest terrestrial zircons ($\sim 4.4$~Ga)
...
\begin{frame}
  \ipsherokey[0.66]{allende}{Allende slab: chondrules and bright CAIs in a dark matrix. \mbox{Credit: James St.\ John, CC BY 2.0.}}{Chondrites never melted whole and keep their mm-scale chondrules; achondrites, irons and stony irons come from parent bodies that short-lived $^{26}\mathrm{Al}$ melted and differentiated: irons are cores, achondrites crusts and mantles.}
\end{frame}

\begin{frame}
  \ipsherokey[0.65]{chondrite_thin}{Cross-polarised thin section of NWA 5930: each chondrule is a mm-scale bead of olivine and pyroxene. \mbox{Credit: H.\ Raab, CC BY-SA 3.0 (Wikimedia Commons).}}{Each chondrule froze from a fully molten droplet in seconds to hours from a peak of $1500$--$1900$~K; how chondrules form remains an unsolved problem.}
\end{frame}

\begin{frame}
  \ipshero{chondrule_cai_timeline}{(a) CAIs at 4567.30 Myr define $t = 0$ and individual chondrules date from $t = 0$ to $2.6$ Myr; (b) a chondrule heating event from a 1700 K peak, cooling at 100 and 1000 K per hour. \mbox{Course figure.}}
\end{frame}
...
\begin{frame}
  \ipsherokey[0.65]{iron_widmanstatten}{Widmanst\"atten pattern in an iron meteorite: a kamacite and taenite Fe-Ni lattice. \mbox{Credit: H.\ Raab, CC BY-SA 3.0 (Wikimedia Commons).}}{The lattice grows only at cooling rates $\lesssim 100$~K~Myr$^{-1}$, inside the metallic core of a body tens of km across; its spacing gives the original parent-body radius.}
\end{frame}

\begin{frame}
  \ipsherokey[0.65]{pallasite}{Esquel pallasite: yellow-green olivine in silvery Fe-Ni metal. \mbox{Credit: UCLA Meteorite Gallery, CC BY-SA 4.0 (Wikimedia Commons).}}{\textbf{Likely a sample of a planetesimal's core-mantle boundary:} molten metal mixed into the olivine of the mantle, possibly during a giant impact.}
\end{frame}

\begin{frame}
  \ipsherokey[0.61]{vesta}{Vesta seen by Dawn (2011--2012), the parent body of the HED meteorites. \mbox{Credit: NASA/JPL-Caltech/UCLA/MPS/DLR/IDA, public domain.}}{HEDs (howardites, eucrites, diogenites, $\sim 6\%$ of falls) match Vesta in mineralogy and oxygen isotopes and were ejected from the Rheasilvia basin; lunar meteorites match the Apollo samples, Martian ones carry trapped Mars atmosphere.}
\end{frame}

\begin{frame}
  \ipshero{oxygen_three_isotope}{Oxygen three-isotope plot: the terrestrial line of slope 1/2, the CAI slope-1 mixing line towards pure $^{16}$O, and the chondrite, HED and SNC fields. \mbox{Course figure.}}
\end{frame}
...
\begin{frame}{Decay Clocks and Early Solar System Timeline}
  ...
  \begin{itemize}\setlength\itemsep{3pt}
    ...
    \item \textbf{Early chronology:} differentiation at $0.5$--$4$~Myr, most chondrules at $1$--$3$~Myr after CAIs
  \end{itemize}
  \vskip6pt
...
\begin{frame}
  \ipsherokey[0.74]{short_lived_decay}{Decay of $^{26}$Al (0.72 Myr half-life) and $^{60}$Fe (2.62 Myr) after CAI formation. \mbox{Course figure.}}{Their rapid decay powered early planetesimal melting and differentiation.}
\end{frame}
...
\begin{frame}
  \ipshero[0.76]{pb_pb_dating}{Pb-Pb isochrons for CAI 22E (Efremovka) and chondrules in the inverse form: the intercept of the mineral-fraction line at zero $^{204}$Pb gives the radiogenic $^{207}$Pb/$^{206}$Pb and so the age $t$, independent of the initial Pb. From \mbox{Connelly et al.\ (2012).}}
\end{frame}

\begin{frame}{Step 5: Numerical Result}
  Connelly et al.\ (2012), CAIs from Efremovka (CV3), one from Allende, after acid leaching:
  \[
  ...
  \begin{itemize}
    ...
    \item Chondrules from Allende and NWA 5697: $0$ to $2.6$~Myr younger
...
\begin{frame}
  \ipsherokeyside{spitzer_nc_cc_ages}{Hf-W ages of NC (red) and CC (blue) iron meteorites: $\varepsilon^{182}\mathrm{W}$ below, the age it gives above. Spitzer et al.\ (2021).}{NC irons ($-3.37$ to $-3.20$) formed cores $1.0$--$2.6$~Myr after CAIs, CC irons ($-3.16$ to $-3.10$) at $3.0$--$3.6$~Myr. NC cores form $\sim 2$~Myr before CC cores.}
\end{frame}
...
\begin{frame}{Three Live Interpretations}
  ...
  \begin{itemize}\setlength\itemsep{4pt}
    ...
    \item \textbf{Temporal change:} the inner-disk composition changed with time during infall (Schiller et al.\ 2018; Spitzer et al.\ 2020)
  \end{itemize}
\end{frame}

\begin{frame}
  \ipsherokey[0.65]{lichtenberg2021_fig1}{Disk simulation in time against orbital distance with two planetesimal formation reservoirs. \mbox{Lichtenberg et al.\ (2021).}}{Reservoir I (red), early and dry in the inner disk, is NC; Reservoir II (blue), later and ice-rich in the outer disk, is CC: the bifurcation arises from disk evolution itself.}
\end{frame}
...
\begin{frame}
  \ipsherokey[0.65]{demeo_carry_belt_inclination}{Asteroid inclination against distance: Hungarias, main belt, Hildas, Trojans. \mbox{DeMeo \& Carry (2014).}}{A total mass of $\sim 4 \times 10^{-4}\,\Mearth$ (Ceres $\approx 40\%$); the vertical gaps are the Kirkwood resonances with Jupiter.}
\end{frame}

\begin{frame}
  \ipsherokey{granvik_kirkwood_resonances}{Orbits of the near-Earth objects that leave the main belt through the 3:1 (2.50 AU), 5:2 (2.82) and 2:1 (3.27) resonances with Jupiter. \mbox{Granvik et al.\ (2018).}}{Periodic Jovian kicks add coherently and pump eccentricities to planet-crossing in $10^4$--$10^6$~yr: the gaps are not empty but leaky, the dynamical sinks that feed the near-Earth population.}
\end{frame}

\begin{frame}
  \ipsherokey[0.65]{asteroid_families_nesvorny}{Asteroid families as clusters in proper inclination against proper semimajor axis: Themis, Eos, Koronis, Eunomia, Vesta, Flora. \mbox{Nesvorn\'y et al.\ (2015).}}{Each family is the debris of a single disruption event; its spread gives the original parent body's size and age.}
\end{frame}

\begin{frame}
  \ipsherokey[0.61]{demeo_carry_belt_mass}{Mass of the main belt by spectral class against semimajor axis. \mbox{DeMeo \& Carry (2014).}}{\textbf{S-types} ($\sim 15\%$ albedo, ordinary-chondrite analogues) fill the inner belt, \textbf{C-types} ($\sim 4\%$ albedo, volatile-rich) $\sim 75\%$ of the outer belt, \textbf{M- and V-types} are cores and Vesta's basaltic crust ($2.4$~AU). Radial sorting preserves the disk's primordial volatile gradient.}
\end{frame}
...
\begin{frame}
  \ipsherokey[0.66]{bannister_ossos_orbits}{1142 characterised TNOs from OSSOS in orbital space; the vertical lines mark Neptune's resonances. \mbox{Bannister et al.\ (2018).}}{The dense low-inclination cluster at 42--47 AU is the cold classical belt; the architecture is a fossil of giant-planet migration.}
\end{frame}

\begin{frame}
  \ipsherokey[0.61]{petit_classical_kbo}{The three components of the CFEPS-L7 model of the classical Kuiper belt in $e$ and $i$ against $a$: hot, stirred, and the kernel near 44 AU. \mbox{Petit et al.\ (2011).}}{Kernel and hot component share the same $a$ but different $(e, i)$: the cold classicals were never strongly perturbed by Neptune, the hot classicals were excited by the giant-planet instability.}
\end{frame}
...
\begin{frame}
  \ipsherokeyside{pluto_color_stern}{True-colour Pluto from New Horizons Ralph (2015), with Tombaugh Regio and Sputnik Planitia. Credit: NASA/JHUAPL/SwRI.}{With $R = 1187$~km and $\rho = 1860$~kg\,m$^{-3}$: water-ice bedrock under volatile frosts, a convecting $\mathrm{N_2}$-ice basin younger than $10$~Myr, a $\sim 1$~Pa $\mathrm{N_2}$ atmosphere and a probable subsurface ocean.}
\end{frame}

\begin{frame}
  \ipsherokey[0.69]{sputnik_convection_mckinnon}{Solid-state convection in Sputnik Planitia, $\mathrm{Ra}_b \sim 3\times 10^5$ (model). \mbox{McKinnon et al.\ (2016).}}{Cells tens of km across overturn in $\sim 10^6$~yr, driven by present-day radiogenic heat in the rocky core.}
\end{frame}

\begin{frame}
  \ipsherokey[0.67]{pluto_charon_features_stern}{Pluto and Charon with their named features, New Horizons (2015). \mbox{Stern et al.\ (2015).}}{Charon ($R = 606$~km, $\sim 1/8$ of Pluto's mass) puts the barycentre \emph{outside} Pluto; the four small moons Styx, Nix, Kerberos and Hydra are likely fragments of an early collisional event.}
\end{frame}

\begin{frame}
  \ipshero{charon_mordor}{Charon from New Horizons: the dark reddish Mordor Macula of tholins from Pluto's escaping atmosphere, and equatorial extensional chasms. \mbox{Credit: NASA/JHUAPL/SwRI, public domain.}}
\end{frame}

\begin{frame}
  \ipsherokey{arrokoth_color_stern}{Arrokoth, a $\sim$35 km \textbf{contact binary}, New Horizons flyby of 1 January 2019. \mbox{Stern et al.\ (2019).}}{Two flat lobes joined at a narrow neck with no impact crater at the join: a merger at $\lesssim$ a few m~s$^{-1}$, formation by streaming-instability gravitational collapse.}
\end{frame}
...
\begin{frame}
  \ipsherokey[0.66]{sedna_orbits_batygin}{Orbits of the detached TNOs and the Planet 9 hypothesis. \mbox{Batygin et al.\ (2019).}}{Sedna ($q = 76$~AU, $Q = 900$~AU, period 11{,}400~yr) is too far for Neptune and too close for present-day stars: an inner Oort cloud or birth-cluster relic; the orbital clustering motivates the \textbf{Planet 9} hypothesis.}
\end{frame}

\begin{frame}
  \ipsherokey[0.6]{oort_cloud_kaib}{Oort cloud formation in two simulations: perihelion $q$ (top) and inclination (bottom) against $a$. \mbox{Kaib \& Quinn (2008).}}{$2{,}000$--$50{,}000$ AU, roughly spherical, $\sim 10^{11}$--$10^{12}$ objects of $\sim 1$--$10\,\Mearth$ in total, planetesimals scattered from the Jupiter-Neptune zone and lifted by the galactic tide and passing stars; inferred by Oort in 1950, \textbf{never directly observed}.}
\end{frame}
...
\begin{frame}
  \ipsherokey[0.66]{comet_diagram}{Anatomy of an active comet. \mbox{Credit: Wikimedia Commons, public domain.}}{Whipple's dirty snowball: a dark, porous \textbf{nucleus} of $1$--$30$~km (67P: $533$ kg m$^{-3}$, $\sim 70\%$ porosity) of ices, dust and organics. Inside $\sim 5$~AU water sublimation feeds a $10^4$--$10^6$~km \textbf{coma}, a straight anti-sunward \textbf{ion tail} and a curved \textbf{dust tail}.}
\end{frame}

\begin{frame}
  \ipsherokey[0.65]{halley}{Halley's nucleus ($15 \times 8 \times 8$~km) with jets from small active patches, Giotto Halley Multicolour Camera, 13--14 March 1986. \mbox{Credit: ESA/MPAe Lindau.}}{A $76$-year retrograde orbit with $T_J \approx -0.6$: an Oort-cloud comet captured to a short period.}
\end{frame}
...
\begin{frame}
  \ipshero[0.76]{67p_nucleus}{Bilobed nucleus of Jupiter-family comet 67P/Churyumov-Gerasimenko ($T_J \approx 2.7$), two lobes joined at a narrow neck by a gentle primordial merger, Rosetta OSIRIS. \mbox{Credit: ESA/Rosetta/MPS for OSIRIS Team.}}
\end{frame}

\begin{frame}
  \ipsherokey[0.6]{hartley2}{103P/Hartley 2 (EPOXI, 2010), whose water D/H matches Earth's oceans. \mbox{Credit: NASA/JPL-Caltech/UMD.}}{Earth's oceans have D/H $= 1.56 \times 10^{-4}$ (VSMOW); Hartley 2 matches, 67P is $\approx 3\times$ and long-period comets $\approx 2\times$ VSMOW. No comet class matches Earth: carbonaceous chondrites dominate Earth's water, comets supply at most a minor fraction.}
\end{frame}
...
\begin{frame}{Three Sample Returns: Itokawa, Ryugu, Bennu}
  \begin{columns}[T]
    ...
    \footnotesize \emph{OSIRIS-REx, 2023}: 121 g. Bennu CI-like, Mg carbonate veins.
  \end{columns}
  \vskip4pt
...
\begin{frame}
  \ipshero[0.76]{dinkinesh_levison}{The Dinkinesh-Selam system from the Lucy flyby of 1 November 2023: the $\sim$720 m main-belt asteroid with its equatorial ridge, and the moonlet Selam, a contact binary of two $\sim$210 and 230 m lobes. \mbox{Levison et al.\ (2024).}}
\end{frame}

\begin{frame}
  \ipshero{psyche_shape_shepard}{The shape of (16) Psyche from radar and adaptive-optics data, seen from above its south pole, with the regions Alpha, Bravo and Charlie where the body falls short of the best-fit ellipsoid. \mbox{Shepard et al.\ (2021).}}
\end{frame}
...
\begin{frame}
  \ipsherokey[0.66]{oumuamua_discovery_meech}{1I/'Oumuamua at the centre; the stars trail as the telescope tracked it. \mbox{Credit: ESO / K.\ Meech et al.}}{No detectable coma at the limit of stacked imaging, yet the outgoing trajectory shows a non-gravitational acceleration; its nature is still debated.}
\end{frame}

\begin{frame}
  \ipsherokey[0.66]{oumuamua_iso_density}{Number density of interstellar objects implied by 'Oumuamua. 'Oumuamua ISSI \mbox{Team (2019).}}{One detection implies $\sim 10^{4}$ ISOs larger than 100 m within Neptune's orbit \emph{at any moment}, each a sample of a different planetary system; the density exceeds the pre-discovery predictions by orders of magnitude.}
\end{frame}

\begin{frame}
  \ipshero[0.76]{borisov_composition_bodewits}{Volatile composition in the coma of interstellar comet 2I/Borisov against solar-system comets: elevated C/O and depleted H/O point to formation beyond the CO snowline of its host system. \mbox{Bodewits et al.\ (2020), Fig.~3.}}
\end{frame}
