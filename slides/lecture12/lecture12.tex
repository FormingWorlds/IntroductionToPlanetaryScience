...
\begin{frame}{Step 5: Numerical Result}
  ...
  \begin{itemize}
    ...
    \item Chondrules from Allende and NWA 5697: a few Myr younger
...
\begin{frame}
  \ipsherokeyside{spitzer_nc_cc_ages}{Hf-W ages of NC (red) and CC (blue) iron meteorites: $\varepsilon^{182}\mathrm{W}$ below, the age it gives above. Spitzer et al.\ (2021).}{NC irons ($-3.37$ to $-3.20$) formed cores $1.0$--$2.6$~Myr after CAIs, CC irons ($-3.16$ to $-3.10$) at $3.0$--$3.6$~Myr. NC cores form $\sim 2$~Myr before CC cores; the ungrouped SBT is $\sim 1$~Myr earlier.}
\end{frame}
...
\begin{frame}
  \ipsherokey[0.65]{demeo_carry_belt_inclination}{Asteroid orbits in inclination against heliocentric distance: Hungarias, the main belt at 2.1--3.3 AU, Hildas, and the Trojans at 5.2 AU. DeMeo \& Carry (2014).}{About 1.4 million catalogued bodies, $\sim 10^6$ above 1 km, a total mass of $\sim 4 \times 10^{-4}\,\Mearth$ (Ceres $\approx 40\%$); the vertical gaps are the Kirkwood resonances with Jupiter.}
\end{frame}
